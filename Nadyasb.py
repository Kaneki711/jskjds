...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    dee.sendContact(to, "u14f64e139a3817afaabe27d237afb36b")
...
#==============================================================================#
                    ...
                    dee.sendMessage(to, "Bot sudah berjalan selama {}".format(str(runtime)))
...
#==============================================================================#
                    ...
                    settings["copy"] = True
                    dee.sendMessage(to, "Kirim Contact Yang Mau Di Copy")
#==============================================================================#
                elif text.lower() == 'me':
...
#==============================================================================#
                    ...
                    if settings["mimic"]["target"] == {}:
                        dee.sendMessage(msg.to,"Tidak Ada Target")
                    else:
                        mc = "╔══[ Mimic List ]"
