...
╚════════════════════╝
"""
oepoll = OEPoll(ririn,dna1,dna2,dna3,dna4,dna5,dna6,dna7,dna8,dna9)
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                            ...
                            for rom in wait2["ROM"][msg.to].items():
                                chiya += rom[1] + "\n"
                        ririn.sendText(msg.to, "========Hai Mblo nyimak aja========%s\n\nSini gabung👻👻👻👻\n[%s]" %(wait2['readMember'][msg.to],setTime[msg.to]))
                        print("ReadPoint Set...")
                        try:
