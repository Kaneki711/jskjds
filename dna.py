...
#Khusus Login Token
ririn = LINE('EsEby7slGJelDwQqcyP7.hOCA6T54lk3cw5YLsZJq9W.tPfLJl2OBn5MvD1I7cliEewLCoqnllBI3dTFh0ebj7A=')
ririn.log("Auth Token : " + str(ririn.authToken))
ririn.log("Timeline Token : " + str(ririn.tl.channelAccessToken))
...
#============================================================#
	...
	#-----------------------------------------------------------------#
            ...
            elif msg.text in ["Lurdna1ng","lurdna1ng"]:
